...
public abstract class GameNotificationDto
{
    protected GameNotificationDto()
    {
        ...
        if (className.EndsWith(suffix))
        {
            ...
            type = FormatNotificationType(baseName);
        }
        else
        {
            type = FormatNotificationType(className);
        }
    }
    ...
    private string FormatNotificationType(string baseName)
    {
        ...
        switch (baseName)
        {
            ...
            case "RoundEnded": return "round:ended";
            case "DrawerWord": return "drawer:word";
            case "DrawerSelected": return "drawer:selected";
